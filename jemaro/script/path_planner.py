...
class PathPublisher(Node):
    ...
    def __init__(self):
        ...
        self.sum_y = 0.0
        # Publisher setup
        self.publisher = self.create_publisher(Path, '/ZOE3/path_follower/setPath', 2000)
        #self.publisher = self.create_publisher(Path, '/path', 2000)
    ...
    def publish_path(self):
        ...
        for i in range(num_points):
            ...
            if distance_y <= -avoiding_thresholdy:
                ...
                inter_pose = (x0 - 0.5, y0 + 5.0, 3/4 *math.pi)
                end_pose = (x0 - 1.0, y0 + 10.0, math.pi/2)
            ...
            elif 1.0 < distance_x < maxavoiding_thresholdx and distance_y > avoiding_thresholdy / 3:
                #turn right
                ...
                inter_pose = (x0 + 0.5, y0 + 5 , math.pi / 4)  # 45 deg left
                end_pose = (x0 + 1.0, y0 + 10 , math.pi/2)  # facing forward, shifted -2m left
